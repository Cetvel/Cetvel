...
router.put('/update', authenticateToken, validate(todoValidation.updateTodo), todoController.updateTodo);
router.delete('/delete', authenticateToken, validate(todoValidation.deleteTodo), todoController.deleteTodo);
