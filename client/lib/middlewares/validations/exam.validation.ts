...
const lgsValidation : ValidationChain[] = [
    ...
    body('examName').isString().notEmpty().withMessage('Sınav adı gerekli'),
    body('saySolvingTime').optional().isInt({ min: 0 }).isInt({ max: 155 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    body('sozSolvingTime').optional().isInt({ min: 0 }).isInt({ max: 155 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    
    body("turkish.solvingTime").optional().isInt({ max: 75 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    ...
    body("math.solvingTime").optional().isInt({ max: 80 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    ...
    body("science.solvingTime").optional().isInt({ max: 80 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    body("science.correct").isInt({ min: 0 }).isInt({ max: 20 }).withMessage('Doğru cevap sayısı pozitif bir tamsayı olmalı'),
    body("science.wrong").isInt({ min: 0 }).isInt({ max: 20 }).withMessage('Yanlış cevap sayısı pozitif bir tamsayı olmalı'),
    body("science.empty").isInt({ min: 0 }).isInt({ max: 20 }).withMessage('Boş cevap sayısı pozitif bir tamsayı olmalı'),
    
    body("social.solvingTime").optional().isInt({ max: 75 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    ...
    body("english.solvingTime").optional().isInt({ max: 80 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
    ...
    body("religious.solvingTime").optional().isInt({ max: 75 }).withMessage('Çözüm süresi pozitif bir tamsayı olmalı'),
